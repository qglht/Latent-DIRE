...
if ! test -f "models/256x256_classifier.pt"; then
...
if ! test -f "models/256x256_diffusion.pt"; then
...
python src/guided-diffusion/scripts/classifier_sample.py --write-dir "data/adm/" $SAMPLE_FLAGS $MODEL_FLAGS --classifier_scale 1.0 --classifier_path models/256x256_classifier.pt --model_path models/256x256_diffusion.pt